...
- Filtered border conflict targets to respect preferred enemy treaties before scoring ().
- Re-ran targeted conventional warfare tests to confirm diplomacy-safe selections (
> vite_react_shadcn_ts@0.0.0 test
> vitest aiActionEnhancements


 DEV  v2.1.9 /workspace/vector-war-games

 ↓ src/lib/__tests__/aiActionEnhancements.test.ts (2 tests)

 Test Files  1 skipped (1)
      Tests   (2)
   Start at  12:06:26
   Duration  3.21s (transform 227ms, setup 0ms, collect 239ms, tests 0ms, environment 1.41s, prepare 220ms)

 CANCELLED  Test run cancelled. Watching for file changes...
       press h to show help, press q to quit
? Input test name pattern (RegExp) › [1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
...
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38G[1G[J? Input test name pattern (RegExp) › 
Please input filter pattern[1A[38Gc[3J RERUN  change pattern 
 ...
 PASS  Waiting for file changes...
       press h to show help, press q to quit
c[3J RERUN  rerun failed 
### 2025-11-13T12:07:57Z - Enforced preferred enemy checks for border offensives
- Filtered border conflict targets to respect preferred enemy treaties before scoring (`src/lib/aiActionEnhancements.ts`).
- Re-ran targeted conventional warfare tests to confirm diplomacy-safe selections (`npm run test -- aiActionEnhancements`).
