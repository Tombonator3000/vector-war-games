              ...
              <div className="p-6 md:p-8">
                {currentLeader && (
                  <div className="space-y-6">
                    ...
                    {/* Doctrine info */}
                    {doctrineName && doctrineDescription && (
                      <div className="space-y-2 bg-neon-green/10 border border-neon-green/30 rounded-lg p-4">
                        <h4 className="font-mono font-bold text-sm text-neon-green">
