...
export function BioWarfareLab({ state, enabled, onUpgrade, onDowngrade, onDeploy, onReset }: BioWarfareLabProps) {
  if (!enabled) {
    return null;
  }
  ...
  return (
    <div className="fixed bottom-20 left-4 z-40 w-96 max-w-[24rem] bg-black/85 border border-cyan-500/40 rounded-lg shadow-lg shadow-cyan-900/20 text-cyan-200 font-mono">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-cyan-500/20 bg-black/60">
