...
export function deployReligiousWeapon(
  ...
  const weapon: ReligiousWeapon = {
    ...
    turnsActive: 0,
    populationMoraleBonus: bonuses.morale || 0,
    unitCombatBonus: bonuses.combat || 0,
    productionBonus: bonuses.production || 0,
    stabilityBonus: bonuses.stability || 0,
    destabilizationEffect: bonuses.target_stability ? Math.abs(bonuses.target_stability) : 0,
    ideologicalConversion: 0,
    resistanceMovements: 0,
    backlashRisk: bonuses.extremism_risk || 0,
    extremismRisk: bonuses.extremism_risk || 0,
